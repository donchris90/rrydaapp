        ...
        >
          ...
          <Text style={styles.subtitle}>
            {viewers && viewers.length > 0
              ? `Choose who to send to (${viewers.length} watching)`
              : 'Choose a viewer to send to'}
          </Text>
          ...
          {isLoading ? (
            ...
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptySub}>
                Once someone joins your live, you'll be able to send them a gift.
              </Text>
            </View>
          ) : (
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <View style={styles.giftChip}>
                    ...
                    <Text style={styles.giftChipText}>Gift</Text>
                  </View>
                </Pressable>
              )}
            />
