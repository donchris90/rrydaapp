...
import type { UserRoundRecord, RoundOutcomeType } from '../../components/dice/luckyNumberTypes';
 ...
 */
export function SumDiceScreen({ navigation, previewResultOutcome, onClearPreviewOutcome }: SumDiceScreenProps) {
    ...
    <View style={[styles.safeArea, { paddingTop: insets.top + 4, paddingBottom: insets.bottom + 10, paddingHorizontal: 8 }]}>
      ...
      <View style={styles.container}>
        <SumDiceGame
          ...
          previewResultOutcome={previewResultOutcome}
          onClearPreviewOutcome={onClearPreviewOutcome}
        />
      </View>
    </View>
  );
