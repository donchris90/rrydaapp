  ...
  return (
    ...
    >
      <div className="relative w-full max-w-lg bg-[#242D3D] rounded-2xl border border-white/10 p-6 shadow-2xl flex flex-col gap-4 text-white">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-white/60">Mathematical proof of non-manipulated outcome</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-3.5 rounded-xl bg-[#192230] border border-white/10 flex items-center justify-between shadow-sm">
          <span className="text-xs font-semibold text-white/70">Final Multiplier</span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-xs font-semibold text-white/80">Server Seed (SHA256 Hash)</span>
            <div className="flex items-center justify-between bg-[#192230] border border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-white/90">
              <span className="truncate pr-2">{round.hash}</span>
              <button
                onClick={() => copyToClipboard(round.hash, 'hash')}
                className="text-white/50 hover:text-[#00E701] transition-colors flex-shrink-0 cursor-pointer"
              >
          ...
          {/* Client Seed */}
          <div className="flex flex-col gap-1">
            <span className="text-xs font-semibold text-white/80">Client Seed</span>
            <div className="flex items-center justify-between bg-[#192230] border border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-white/90">
          ...
          {/* Nonce */}
          <div className="flex flex-col gap-1">
            <span className="text-xs font-semibold text-white/80">Nonce</span>
            <div className="bg-[#192230] border border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-white/90">
              {round.nonce}
            </div>
          </div>
        </div>
        ...
        <div className="p-3 bg-[#00E701]/10 border border-[#00E701]/20 rounded-xl text-[11px] text-white/80 leading-relaxed">
