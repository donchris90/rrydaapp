              ...
              {(['Popular', 'PK Buff', 'Luxury', 'Effects'] as const).map((tab) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-bold transition-all ${
                    activeTab === tab
                      ? 'bg-gradient-to-r from-[#FF2A6D] to-[#FF2E7E] text-white shadow-md'
              ...
              return (
                <button
                  ...
                  className={`relative p-2 rounded-xl flex flex-col items-center justify-center transition-all border ${
                    isSelected
                      ? 'bg-gradient-to-b from-[#FF2A6D]/20 to-[#FF2E7E]/20 border-[#FF2A6D] shadow-[0_0_12px_rgba(255,42,109,0.4)] scale-105'
