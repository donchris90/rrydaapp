...
const SOUND_FX = [
  ...
  { key: 'applause', label: 'Applause', icon: 'hand-left', color: '#FF3D8A' },
  { key: 'laugh', label: 'Laughter', icon: 'happy', color: '#3DF5A0' },
  { key: 'airhorn', label: 'Airhorn', icon: 'megaphone', color: '#7B4DFF' },
        ...
        <Pressable style={styles.sheetContent} onPress={(e) => e.stopPropagation()}>
          ...
          {activeTab === 'tools' && (
            <View style={styles.grid}>
              ...
              >
                <View style={[styles.toolIconWrap, { backgroundColor: '#FF3D8A' }]}>
              ...
              >
                <View style={[styles.toolIconWrap, { backgroundColor: '#FFC24B' }]}>
                  <Ionicons name="flash" size={24} color="#120B26" />
                </View>
              ...
              <Pressable style={styles.toolTile} onPress={toggleNoiseSuppression}>
                ...
                >
                  <Ionicons
                    name="ear-outline"
                    size={24}
                    color={isNoiseSuppressionOn ? '#120B26' : '#FFF'}
                  />
                </View>
              ...
              <Pressable style={styles.toolTile} onPress={handleShare}>
                <View style={[styles.toolIconWrap, { backgroundColor: '#7B4DFF' }]}>
            ...
            <View style={styles.soundsWrap}>
              ...
              <View style={styles.grid}>
                {SOUND_FX.map((s) => (
                  ...
                  >
                    <View style={[styles.toolIconWrap, { backgroundColor: '#2E2453' }]}>
